...
app.get('/api/task', async (req, res) => {
    try {
        ...
        const response = await fetch('https://api.limblecmms.com:443/v2/tasks/?locations=13425&orderBy=-createdDate&limit=10&type=2,6&status=0', {
            method: 'GET',
            headers: headers
        });
...
app.get('/api/taskpm', async (req, res) => {
    try {
        ...
        const response = await fetch('https://api.limblecmms.com:443/v2/tasks/?locations=13425&type=1&orderBy=-createdDate&limit=10&status=0', {
            method: 'GET',
            headers: headers
        });
